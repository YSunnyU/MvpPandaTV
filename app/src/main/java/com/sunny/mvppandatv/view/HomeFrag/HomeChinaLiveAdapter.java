...
public class HomeChinaLiveAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
//    List<HomeNewsMess.DataBean.ChinaliveBean.ListBeanXX> dataList;
    List<HomeNewsMess.DataBean.ChinaliveBean.ListBean> dataList;
    private Context context;

    public HomeChinaLiveAdapter(List<HomeNewsMess.DataBean.ChinaliveBean.ListBean> list, Context context) {
        this.dataList = list;
