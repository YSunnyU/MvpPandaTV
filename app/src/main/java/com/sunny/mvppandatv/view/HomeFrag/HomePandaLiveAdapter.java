...
public class HomePandaLiveAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {

    List<HomeNewsMess.DataBean.PandaliveBean.ListBeanX> dataList;
    private Context context;

    public HomePandaLiveAdapter(List<HomeNewsMess.DataBean.PandaliveBean.ListBeanX> list, Context context) {
        this.dataList = list;
